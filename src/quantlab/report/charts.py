...
# Colorblind-safe categorical strokes.
_PALETTE = ["#2563eb", "#e8703a", "#16a34a", "#9333ea", "#dc2626"]
_PAD = 36
...
def drawdown_chart(equity: pd.Series, *, width: int = 720, height: int = 180) -> str:
    ...
    return (
        ...
        f'<polygon points="{area}" fill="#dc2626" fill-opacity="0.18"/>'
        f'<polyline points="{pts}" fill="none" stroke="#dc2626" stroke-width="1.5"/>'
        ...
        f'fill-opacity="0.7">drawdown</text></svg>'
    )
